    ...
    <div class="about-stage">
        ...
        <div class="about-content">
            ...
            <p class="zalando paragraph">
                ...
                <strong>Cybersecurity</strong>. I spend most of my time building, redesigning, or just figuring out
                how things work behind the scenes. When I'm not doing that, I'm probably drawing, messing with music,
                or getting into anything that's creative, really.
            </p>
        </div>
    </div>
{/if}
...
<style>
    ...
    .hey-line {
        ...
        justify-content: flex-end;
        width: 100%;
        animation: hey-weight 0.72s cubic-bezier(0.65, 0, 0.35, 1) 1.1s forwards,
