...
<div class="nc-bg-grey-l">
    <div class="container footer-cta-section" class:no-motion={!motionEnabled}>
        <div class="nc-footer-cta-wrapper">
            <div class="nc-padding-top-section-l nc-padding-bottom-l nc-hxl" class:is-visible={ctaTextVisible} bind:this={ctaText}>
                <p class="footer-copy">
                    <span>
        ...
        <div class="cta-button-wrapper nc-padding-bottom-m-s nc-padding-top-s contact-link" class:is-visible={ctaLinkVisible} bind:this={ctaLink}>
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" class="cta-arrow" aria-hidden="true">
                    <path d="M10 0.787109L20 10.7871M20 10.7871L10 20.7871M20 10.7871L0 10.7871" stroke="#050516" stroke-width="2"></path>
                </svg>
            </a>
        </div>
    </div>
